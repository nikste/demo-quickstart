...
import org.apache.flink.streaming.connectors.rabbitmq.RMQTopology.StringToByteSerializer
...
object JobStreamingRabbitMQTest {
  ...
  def main(args: Array[String]) {
    ...
    tablerows.addSink(new RMQSink[String]("localhost", "FLINK_OUT", new StringToByteSerializer))
